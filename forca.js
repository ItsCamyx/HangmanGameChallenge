...
let btnNovoJogoSumir = (document.getElementById("btn-novo-jogo").style.display =
  "none");
let btnSairDesaparecer = (document.getElementById("btn-sair").style.display =
  "none");
let divJuntarPalavra = (document.getElementById(
  "adicionar-palavra"
).style.display = "none");
...
var jogo = document.getElementById("forca").getContext("2d");
var palavraSecreta = "";
var letras = [];
var palavraCorreta = "";
var erros = 8;
